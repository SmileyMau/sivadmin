...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('css/style_muertos.css')}}">

  </head>
  <body class="hold-transition login-page">
    <img src="{{asset($img)}}" alt="" class="img-login">
    <div class="login-box">
      <!-- /.login-logo -->
      <div class="card {{$style_card}} card-outline {{$color_card}} ">
        ...
        <div class="card-body ">
          ...
          <form action="{{ route('login') }}" method="post">
            ...
            <div class="input-group mb-3">
              <input type="text" class="form-control {{$style_input}}" placeholder="Usuario" value="{{old('user')}}" name="user" id="input_user" autofocus value="{{ old('name') }}" require>
            ...
            <div class="input-group mb-3">
              <input type="password" class="form-control {{$style_input}}" placeholder="Contraseña" name="password" id="input_pass"  require>
              <div class="input-group-append">
                <div class="input-group-text">
            ...
            <div class="row">
              ...
              <!-- /.col -->
              <div class="col-4">
                <button type="submit" class="btn btn-primary btn-block {{$style_btn}}">Iniciar</button>
              </div>
              <!-- /.col -->
            </div>
          </form>
