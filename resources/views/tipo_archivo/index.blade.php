...
<section class="content">
  ...
  <div class="card card-outline card-celsh">
    <div class="card-header">
      <h3 class="card-title">Lista de tipos de archivos</h3>
                      ...
                      <td  class="text-center">
                          <div class="dropstart " style="z-idex: 999;"> 
                              ...
                              <div class="dropdown-menu p-2" role="menu">
                                <a class="dropdown-item btn-editar mb-1" href="{{ route('TipoArchivo.edit', $tipo->id) }}">Editar</a>
                                @if ($tipo->status == 'A')
                                  <form method="post" action="{{ route('TipoArchivo.destroy', $tipo->id) }}" class="form_cancelar">
                                    @method('delete')
                                    @csrf
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="{{route('TipoArchivo.store')}}" enctype="multipart/form-data">
            @method('post')
            @csrf
