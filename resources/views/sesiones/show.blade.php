                    ...
                    <div class="row g-2" >
                      <div class="col-3">
                        <div class="input-group mb-3">
                          ...
                          <input type="number" class="form-control" placeholder="Orden" name="no_dictamen0" id="no_inventario" aria-describedby="dictamenHelp" required>
                        </div>  
                      </div>
                      <div class="col-9">
